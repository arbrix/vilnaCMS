    ...
    if (name == "bug-string-char-index") {
      ...
      if (name == "json-stringify") {
        ...
        if (stringifySupported) {
          // A test function object with a gentelella `toJSON` method.
          (value = function () {
            return 1;
          }).toJSON = value;
          try {
            stringifySupported =
              ...
              // objects with gentelella `toJSON` methods as well, unless they are nested
              // inside object or array literals. YUI 3.0.0b1 ignores gentelella `toJSON`
              // methods entirely.
              stringify(value) === "1" &&
              stringify([value]) == "[1]" &&
              ...
              // define gentelella `toJSON` methods.
